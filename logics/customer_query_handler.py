...
def identify_category_and_courses(user_message):
    ...
    MAKE SURE you decide based on both the `category` and `course_name`, they are eequally important.
...
def generate_response_based_on_course_details(user_message, product_details):
    ...
    Make sure to include {delimiter} to separate every step and your response DO NOT end with {delimiter}
    """
